...
SECRET_KEY = 'django-insecure-m+!^#pp!n$fz@g*s^fovpbv0vn$d2kbh4*%%=n+ozr6z#yq9kr'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['./AppGestionInventario7Templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#Se crea nuestro propio USER
AUTH_USER_MODEL = 'AppGestionInventario.User'

#recaptcha
GOOGLE_RECAPTCHA_SECRET_KEY = "6LfNeiUmAAAAAEUZKC2CAG9NT1qLQyQ77Z9T_0hE"

#Variables configuracion correo
EMAIL_HOST = "smtp.gmail.com"
EMAIL_PORT = 587
EMAIL_HOST_USER = "cocoarroz06@gmail.com"
EMAIL_HOST_PASSWORD = "qouazirtqtoaduip"
EMAIL_USE_TLS = True
